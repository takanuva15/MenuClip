...
;;This function is derived from the LB_InsertItemAtIndex function above. It is under MIT license except for the LB_InsertItemAtIndex function itself.
PopulateLBFromArray(HListBox, arr) {
	GuiControl, -Redraw, HListBox
	for index, element in arr {
		LB_InsertItemAtIndex(HListBox, element, index)
	}
	GuiControl, +Redraw, HListBox
}